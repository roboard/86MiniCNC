...
#define JOGBTN_Active_HIGH	0x0000
#define JOGBTN_Active_LOW	0x8000
...
class MyMachine
{
  public:
    ...
    bool config_EGearSlave(MyMachine &target, double xRatio, double yRatio, double zRatio);
    ...
    void setJogPins(int pX, int nX, int pY, int nY, int pZ, int nZ);
    ...
    void beginJog(int pX, int nX, int pY, int nY, int pZ, int nZ, bool incJog = false);
    void endJog();
  ...
  private:
    ...
    /*additional: MyMotion86*/
  public:
    void beginJog(int pX, int nX, bool incJog = false);
    void setJogAxis(int axis);
    void myHome();
};
